var DukeMap = {
  ...
  read_sector() {
    ...
    */
    var sector = {
      wallptr: self.read("INT16LE"), wallnum: self.read("INT16LE"),
      z: [self.read("INT32LE"), self.read("INT32LE")],
      stat: [self.read("INT16LE"), self.read("INT16LE")],
      surf: [self.read_surface(), self.read_surface()],
